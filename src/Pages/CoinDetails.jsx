...
import { fetchCoinData, fetchChartData } from "../API/CoinGeckos";
...
const CoinDetails = () => {
  ...
  const loadCoinData = async (id) => {
    try {
      const cryptoCoin = await fetchCoinData(id);
      setCoin(cryptoCoin);
    } catch (err) {
      console.error("Error while fetching crypto coin:", err);
    } finally {
      setIsLoading(false);
    }
  };
      ...
      <div className="coin-detail">
        <div className="coin-header">
          <div className="coin-title">
            <img src={coin.image.large} alt={coin.image.large} />
            <div>
              <h1>{coin.name}</h1>
